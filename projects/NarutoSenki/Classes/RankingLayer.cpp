...
bool RakingLayer::init()
{
	...
	do
	{
		...
		{
			SimpleAudioEngine::sharedEngine()->playBackgroundMusic(RANKING_MUSIC, true);
		}
...
void RakingLayer::onHttpRequestCompleted(CCHttpClient* client, CCHttpResponse* response)
{
