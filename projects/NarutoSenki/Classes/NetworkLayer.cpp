...
bool NetworkLayer::init()
{
	...
	do
	{
		...
		// onListRequestCompleted(NULL, NULL);
...
void NetworkLayer::onListRequestCompleted(CCHttpClient* client, CCHttpResponse* response)
{
